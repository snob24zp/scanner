/*
 ## Cypress FX3 Firmware Example Source File (cyfxsramusbdscr.c)
 ## ===========================
 ##
...
/* This file contains the USB descriptors for the FX3-SRAM Master application example.
 */
